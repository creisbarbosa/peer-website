    ...
    <>
      ...
      <section className="bg-blue-50">
        <div className="flex items-center justify-center px-40 py-32">
          <p className=" text-blue-500 text-center text-3xl w-[55%] font-display" >O que fazemos é <strong>unir empresas com capacidade produtiva ociosa com outras que apresentam demanda por fabricação</strong>.</p>
        </div>
      </section>
      {/*Third Section*/}
      <section className="bg-blue-50">
        <div className="grid grid-cols-4 gap-6 px-48 pt-16 pb-32">
          ...
          <div className="bg-white border-solid border-4 border-blue-500 rounded-2xl flex gap-4 p-5 text-blue-500 shadow-3xl aspect-square">
            <h4 className="text-xl font-bold font-display">1</h4>
            <p>Somos uma <b>empresa de tecnologia</b></p>
          </div>
          <div className="bg-white border-solid border-4 border-blue-500 rounded-2xl flex gap-4 p-5 text-blue-500 shadow-3xl aspect-square">
            <h4 className="text-xl font-bold font-display">2</h4>
            <p>Conectamos empresas que compram/ vendem peças usinadas por meio de uma <b>inovadora plataforma digital</b></p>
          </div>
          <div className="bg-white border-solid border-4 border-blue-500 rounded-2xl flex gap-4 p-5 text-blue-500 shadow-3xl aspect-square">
            <h4 className="text-xl font-bold font-display">3</h4>
            <p>Nossas soluções tornam o mercado de <b>usinagem mais eficiente e menos burocrático</b></p>
          </div>
          <div className="bg-white border-solid border-4 border-blue-500 rounded-2xl flex gap-4 p-5 text-blue-500 shadow-3xl aspect-square">
            <h4 className="text-xl font-bold font-display">4</h4>
            <p>Nossos Parceiros de Manufatura fabricam peças, utilizando sua <b>capacidade produtiva ociosa</b>, cumprindo todas as especificações técnicas e prazos de entrega</p>
          </div>
          <div className="bg-white border-solid border-4 border-blue-500 rounded-2xl flex gap-4 p-5 text-blue-500 shadow-3xl aspect-square">
            <h4 className="text-xl font-bold font-display">5</h4>
            <p>Nossos clientes podem comprar, em poucos cliques, peças usinadas <b>sem a necessidade de cotação</b> com fornecedores especialistas</p>
          </div>
          <div className="bg-white border-solid border-4 border-blue-500 rounded-2xl flex gap-4 p-5 text-blue-500 shadow-3xl aspect-square">
            <h4 className="text-xl font-bold font-display">6</h4>
            <p><b>Gerenciamos de ponta a ponta os processos de compra e venda</b> dos nossos parceiros comerciais</p>
          </div>
          <div className="bg-white border-solid border-4 border-blue-500 rounded-2xl flex gap-4 p-5 text-blue-500 shadow-3xl aspect-square">
            <h4 className="text-xl font-bold font-display">7</h4>
            <p>Formamos a <b>maior rede digital de usinagem conectada da América Latina</b></p>
          </div>
        </div>
      </section>
      {/* Second Section */}
      <section className="bg-blue-50">
        <div className="px-40 py-32 flex flex-col gap-6">
          <h2 className="text-4xl font-bold text-blue-500 w-1/3">Transformando o mercado de usinagem</h2>
      ...
      {/*Fourth Section*/}
      <section className="bg-blue-50 px-48 py-32">
        ...
        <div className="grid grid-cols-3 gap-6 px-32 py-16">
