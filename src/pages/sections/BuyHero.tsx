...
import Illustration from "../../../public/il_bg_02.svg"
  ...
  return (
    <section 
      ...
      >
        ...
        <Image src={Illustration} alt="" className="right-28 top-32 object-cover absolute"/>
        <div className="px-16 xl:px-40 2xl:px-60 py-32  space-y-12  relative">
          ...
          <h1 className="text-4xl xl:text-5xl font-bold font-display text-blue-50 w-3/4 xl:w-4/5 2xl:w-2/3">Compre peças usinadas<br /> sem necessidade de cotação</h1>
          <p className="text-blue-50 leading-7 w-[45%]">
          A Peerdustry produz as suas demandas com prazos de entrega curtos e garantia de qualidade. Compre peças usinadas economizando tempo e dinheiro. 
          </p>
          <a href="https://api.whatsapp.com/send/?phone=5511960840395&text&type=phone_number&app_absent=0" target="blank">
            <button 
              type="submit"
